...
export function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 hidden md:flex items-center justify-center w-14 h-14 rounded-full shadow-2xl shadow-green-200 hover:scale-110 transition-transform duration-200"
